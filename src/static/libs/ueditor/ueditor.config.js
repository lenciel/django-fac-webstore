...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/admin/foundation/image/upload"             //图片上传提交地址
        ,imagePath:""                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageFieldName:"image_file"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        "selectall","print","searchreplace","preview","help","|","insertimage","horizontal","bold","italic","underline",
        "strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify",'fontfamily',
        "fontsize","imagenone","imageleft","imageright","imagecenter", "|", "lineheight"]]
