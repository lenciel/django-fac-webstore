!function (c) {
  ...
  d.prototype = {constructor: d, setColor: function (f) {
    f = f.toLowerCase();
    var e = this;
  ...
  a.prototype = {constructor: a, show: function (f) {
    ...
    if (!f.is(".colorpicker")) {
      ...
      c(document).on({mousemove: c.proxy(this.mousemove, this), mouseup: c.proxy(this.mouseup, this)}).trigger("mousemove")
    }
    return false
  ...
  var b = {translateFormats: {rgb: function () {
  ...
  }}, sliders: {saturation: {maxLeft: 100, maxTop: 100, callLeft: "setSaturation", callTop: "setLightness"}, hue: {maxLeft: 0, maxTop: 100, callLeft: false, callTop: "setHue"}, alpha: {maxLeft: 0, maxTop: 100, callLeft: false, callTop: "setAlpha"}}, RGBtoHSB: function (l, k, e, h) {
    l /= 255;
    k /= 255;
    e /= 255;
    var j, i, f, m;
